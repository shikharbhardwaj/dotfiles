...
if [[ -n $DEVSTAT_HOME_DIR ]]; then
    HOME_DIR=$DEVSTAT_HOME_DIR
fi

# declare -a repos=("instabase" "instabase_fork_001" "instabase_fork_002")
repos=("instabase_fork_000" "instabase_fork_001" "instabase_fork_002")
